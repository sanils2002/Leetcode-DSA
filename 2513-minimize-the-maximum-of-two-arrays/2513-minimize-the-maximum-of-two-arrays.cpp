...
public:
    int minimizeSet(int divisor1, int divisor2, int uniqueCnt1, int uniqueCnt2) {
        long gc_d = gcd(divisor1,divisor2), lcm=(long)divisor1*(long)divisor2/gc_d;
        ...
        long nondiv1 = (divisible2 - 1) * batches, nondiv2 = (divisible1 - 1) * batches;
        long common = nondivisibleCommon * batches;
